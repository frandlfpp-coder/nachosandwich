    ...
    <AppShell>
      <section>
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-4xl tracking-tighter font-black uppercase">Comandas</h2>
          <div className="bg-primary text-primary-foreground px-4 py-2 rounded-full text-[10px] font-black uppercase">
        ...
        <div id="kitchen-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {orders.map(o => (
            <div key={o.id} className="bg-card text-card-foreground rounded-[3rem] p-8 border shadow-xl animate-pop">
              ...
              <ul className="text-xs space-y-2 mb-8 border-l-4 border-primary pl-4 font-black uppercase">
